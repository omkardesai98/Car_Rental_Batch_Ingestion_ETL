...
CLUSTER_NAME = 'cluster-77c5'
PROJECT_ID = 'cryptic-ground-427116-h6'
REGION = 'asia-east1'

pyspark_job_file_path = 'gs://snowflake-projects/spark_job/pyspark_code.py'
...
submit_pyspark_job = DataprocSubmitPySparkJobOperator(
    ...
    dag=dag,
    dataproc_jars=['gs://snowflake-projects/snowflake_jars/spark-snowflake_2.12-2.15.0-spark_3.4.jar', 'gs://snowflake-projects/snowflake_jars/snowflake-jdbc-3.16.0.jar']
)
