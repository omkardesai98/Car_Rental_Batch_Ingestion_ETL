-- creating schema for car_rental
use project; -- select database
create schema car_rental;

-- creating dimension tables 

-- location_dim dimension table
...
-- creating table for customer_dim table 
...
-- creating table for rental_fact table
...
STORAGE_ALLOWED_LOCATIONS = ('gcs://snowflake-projects/car_rental_data/customer_daily_data/')
ENABLED = TRUE;

desc storage integration gcs_car_rental_integration;


CREATE OR REPLACE STAGE car_rental_data_stage
URL = 'gcs://snowflake-projects/car_rental_data/customer_daily_data/'
